...
public enum ImageInfo {
    BabeA ("characters/babe-a", "characters/babe-a-wave", 0.1f, Sounds.none, 0.5f, 0.5f, true),
    BabeB ("characters/babe-b", "characters/babe-b-wave", 0.1f, Sounds.none, 0.5f, 0.5f, true),
    Dude ("characters/dude-a", null, 0.1f, Sounds.none, 0.5f, 0.5f, true),
